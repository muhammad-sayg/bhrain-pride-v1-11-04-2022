...
<div class="tab9">
    ...
    <p>
		<?php
			_e('In addition to the email- and follow-icon you can also show a subscription form that that maximizes the chances that people subscribe to your the site.', SFSI_PLUS_DOMAIN);
		?>
	</p>
    ...
    <div class="sfsi_plus_tab8_container">
        ...
        <div class="sfsi_plus_tab8_subcontainer sfsi_plus_seprater">
    		<h3 class="sfsi_plus_section_title">
            	<?php _e( 'Place it on your the site', SFSI_PLUS_DOMAIN ); ?>
            </h3>
            ...
            <div class="sfsi_plus_right_container">
            	<div class="row_tab">
                    <label class="sfsi_plus_heding">
                    	<?php  _e( 'Adjust the size to space on the website?', SFSI_PLUS_DOMAIN ); ?>
                    </label>
        ...
        <div class="sfsi_plus_tab8_subcontainer sfsi_plus_seprater">
        	<h5 class="sfsi_plus_section_subtitle">
            	<?php  _e( 'Text above the entry field', SFSI_PLUS_DOMAIN ); ?>
            </h5>
